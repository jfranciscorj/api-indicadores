      ...
      <div class="card-body">
        ...
        @csrf
          ...
          <div class="form-group">
            ...
            <input type="text" name="name" class="form-control" placeholder="Ingrese nombre de rol" value="{{ old('name') }}" required>
            @error('name')
              ...
              @foreach($permisos as $permiso)
                @if(Illuminate\Support\Str::contains($permiso->name, "admin")) 
                  <div class="form-check">
                      <input type="checkbox" class="form-check-input" name="permissions[]" id="" value="{{$permiso->id}}">
          ...
          <input type="submit" value="Crear rol" class="btn btn-outline-primary">
        </form>
      </div>
      <!-- /.card-body -->
